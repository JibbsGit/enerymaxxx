...
export const testimonials: Testimonial[] = [
  ...
  {
    name: 'Ngozi Eze',
    role: 'Mushroom Farmer, Ibadan',
    quote:
      'EnergyMaxx set up our mushroom house from the ground up. The controlled environment they designed has doubled our harvest yield.',
  ...
  },
  {
    ...
    role: 'Beekeeper, Jos',
    quote:
      'Their apiary setup and extraction equipment took our honey production from a hobby to a real commercial operation.',
